...
class mPng
{
	...
	//	unsigned char& value(int i, int j, int k) { return *(data + (i*width*4 + j*4 + k )); }
	//	const unsigned char& value(int i, int j, int k) const { return *(data + (i*width*4 + j*4 + k )); }
	};
